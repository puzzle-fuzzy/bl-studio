/**
 * 为 infra/seed/model-costs.json 中列出的模型播种 model_costs 默认成本单价。
 *
 ...
 *
 * 用法：DATABASE_URL=<url> tsx infra/scripts/seed-model-costs.ts
 *（或 pnpm run db:seed:model-costs）
 */
import postgres from 'postgres'
import seedCosts from '../seed/model-costs.json'
