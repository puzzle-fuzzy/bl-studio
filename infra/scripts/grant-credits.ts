 ...
 *     --env-file /opt/bailian-studio/infra/env/.env.production \
 *     -e GRANT_AMOUNT_CENTS=2000 \
 *     -v /opt/bailian-studio/infra/scripts/grant-credits.ts:/app/infra/scripts/grant-credits.ts:ro \
 *     bailian-studio-runtime:<SHA> pnpm exec tsx infra/scripts/grant-credits.ts
 */
