...
-   以下参数通过`OmniRealtimeConversation`的`update_session`方法设置。
    ...
    **说明**
    ...
    可选值：参见[支持的音色](/zh/model-studio/qwen3-5-livetranslate-flash-realtime#0a5bde7593gdk)。
...
-   以下参数通过`TranslationParams`的构造方法设置。
    ...
    **说明**
    ...
    可选值：参见[支持的语种](/zh/model-studio/qwen3-5-livetranslate-flash-realtime#4ffd192226f0s)。
...
[服务端事件](/zh/model-studio/live-translator-server-events)
...
[session.finished](/zh/model-studio/live-translator-server-events#5369266402pgb)
...
[input\_audio\_buffer.committed](/zh/model-studio/live-translator-server-events#ltcommitted001h2)
...
[input\_audio\_buffer.cleared](/zh/model-studio/live-translator-server-events#ltcleared001h2)
...
message：[服务端事件](/zh/model-studio/live-translator-server-events)
