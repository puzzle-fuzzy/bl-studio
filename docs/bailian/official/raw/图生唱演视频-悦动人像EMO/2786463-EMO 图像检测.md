...
该模型用于检测输入的图片是否满足“[EMO 视频生成](/zh/model-studio/emo-api)”所需的人物肖像图片规范。
...
请求失败时返回的错误码，详情请参见[状态码说明](/zh/model-studio/emo-api#933856b630hez)。
...
请求失败时返回的详细错误信息，详情请参见[状态码说明](/zh/model-studio/emo-api#933856b630hez)。
