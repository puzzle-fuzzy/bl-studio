...
- Model catalog responses come from `deps.modelCatalog`, a provider-neutral port supplied by the API composition root; do not rebuild model metadata in route code.
