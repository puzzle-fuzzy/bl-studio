...
import { ProtectedRoute } from '@bailian-studio/app-shell'
import { RedirectIfAuthed } from '@bailian-studio/app-shell'
...
import { LoginPage } from '@bailian-studio/app-shell'
    ...
    children: [
      { path: '/', element: <Navigate to="/workbench" replace /> },
      {
        ...
        children: [
          ...
          { path: '/create', element: lazyPage('CreatePage', () => import('@/pages/CreatePage')) },
      ...
      { path: '/auth/verify-email', element: lazyPage('VerifyEmailPage', () => import('@bailian-studio/app-shell')) },
      { path: '/auth/check-email', element: lazyPage('CheckEmailPage', () => import('@bailian-studio/app-shell')) },
      { path: '/auth/forgot-password', element: lazyPage('ForgotPasswordPage', () => import('@bailian-studio/app-shell')) },
      { path: '/auth/reset-password', element: lazyPage('ResetPasswordPage', () => import('@bailian-studio/app-shell')) },
