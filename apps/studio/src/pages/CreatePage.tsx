...
import { useInvalidateGenerations, useGenerationList } from '@/hooks/use-generations'
...
import { idempotencyKeyFor, clearIdempotencyKey } from '@bailian-studio/app-shell'
...
export function CreatePage() {
  ...
  const refreshGenerations = useInvalidateGenerations()
  const generationRecords = useGenerationList().data?.pages.flatMap(page => page.items) ?? []
