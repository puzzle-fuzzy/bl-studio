...
- Task handlers consume normalized `ProviderRunner` results and own orchestration only. They must not understand SDK payload/response schemas or call DashScope.
